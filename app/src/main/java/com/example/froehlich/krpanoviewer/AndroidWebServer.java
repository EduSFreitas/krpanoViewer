...
import com.example.froehlich.krpanoviewer.auth.ExampleGuestOnlyAuthHandler;
...
public class AndroidWebServer {
    ...
    public void start(Context androidContext) {
        ...
        httpApplication = new HttpApplication(8080, androidContext, null, fileResolver, authHandler);
